...
import Expenses from "@/components/table/expenses";
...
export default function Page() {
	return (
		<div className="mb-4 grid gap-4 px-5 sm:grid-cols-12 xl:mx-auto xl:w-full xl:max-w-[1600px] xl:grid-cols-10 xl:px-12">
			<div className="sm:col-span-6 sm:col-start-1 sm:row-start-2 xl:col-span-4 xl:col-start-5 xl:row-start-1">
			...
			<div className="sm:col-span-6 sm:col-start-7 xl:col-span-2">
				<StatCard heading="total expenses" icon="Wallet" value={250.8} isCurrency />
			</div>
		</div>
	);
}
