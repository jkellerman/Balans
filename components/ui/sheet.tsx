...
>(({ className, ...props }, ref) => (
	<SheetPrimitive.Close
		className={cn(
			"focus:ring-ring absolute right-6 top-8 rounded-lg p-2 opacity-70 ring-offset-quaternary transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none",
			className
		)}
		{...props}
		ref={ref}
