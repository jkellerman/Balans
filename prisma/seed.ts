	...
	await prisma.recurringPayment.createMany({
		data: [
			...
			},
			{
				...
				amount: 7.99,
				interval: "MONTHLY",
				firstPaymentDate: getDateFromToday(-130),
				nextPaymentDate: getDateFromToday(9),
				categoryId: categoryMap["Subscriptions"],
				userId: user.id,
			},
			{
				...
				amount: 8.99,
				interval: "MONTHLY",
				firstPaymentDate: getDateFromToday(-135),
				nextPaymentDate: getDateFromToday(4),
				categoryId: categoryMap["Subscriptions"],
				userId: user.id,
			},
			{
				...
				amount: 11.99,
				interval: "MONTHLY",
				firstPaymentDate: getDateFromToday(-138),
				nextPaymentDate: getDateFromToday(7),
				categoryId: categoryMap["Subscriptions"],
				userId: user.id,
			},
			{
				...
				amount: 10.99,
				interval: "MONTHLY",
				firstPaymentDate: getDateFromToday(-125),
				nextPaymentDate: getDateFromToday(11),
				categoryId: categoryMap["Subscriptions"],
				userId: user.id,
			},
			{
			...
			},
			{
				...
				amount: 7.99,
				interval: "MONTHLY",
				firstPaymentDate: getDateFromToday(-133),
				nextPaymentDate: getDateFromToday(13),
				categoryId: categoryMap["Subscriptions"],
				userId: user.id,
			},
			{
				...
				amount: 12.99,
				interval: "MONTHLY",
				firstPaymentDate: getDateFromToday(-128),
				nextPaymentDate: getDateFromToday(6),
				categoryId: categoryMap["Subscriptions"],
				userId: user.id,
			},
			{
				...
				nextPaymentDate: getDateFromToday(14),
				categoryId: categoryMap["Subscriptions"],
				userId: user.id,
			},
			{
				...
				amount: 3.49,
				interval: "MONTHLY",
				firstPaymentDate: getDateFromToday(-115),
				nextPaymentDate: getDateFromToday(1),
				categoryId: categoryMap["Subscriptions"],
				userId: user.id,
			},
			{
				...
				amount: 10.99,
				interval: "MONTHLY",
				firstPaymentDate: getDateFromToday(-118),
				nextPaymentDate: getDateFromToday(8),
				categoryId: categoryMap["Subscriptions"],
				userId: user.id,
			},
			{
				...
				amount: 2.99,
				interval: "MONTHLY",
				firstPaymentDate: getDateFromToday(-146),
				nextPaymentDate: getDateFromToday(5),
				categoryId: categoryMap["Subscriptions"],
				userId: user.id,
			},
			{
				...
				amount: 11.99,
				interval: "YEARLY",
				firstPaymentDate: getDateFromToday(-200),
				nextPaymentDate: getDateFromToday(165),
				categoryId: categoryMap["Subscriptions"],
				userId: user.id,
			},
		],
